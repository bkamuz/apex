...
export const exportProject: () => [number, number, number, number];
export const getScene: () => [number, number, number];
export const getSelected: () => [number, number, number];
export const importProject: (a: number, b: number) => [number, number, number];
...
export const newProject: () => [number, number, number];
